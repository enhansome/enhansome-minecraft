...
* [Minecraft Forge](https://github.com/MinecraftForge/MinecraftForge) ⭐ 7,786 | 🐛 180 | 🌐 Java | 📅 2026-08-27 - Modifications to the Minecraft base files to assist in compatibility between mods.
...
* [Sodium (for Fabric)](https://github.com/CaffeineMC/sodium-fabric) ⭐ 5,763 | 🐛 157 | 🌐 Java | 📅 2026-09-12 - A Fabric mod designed to improve frame rates and reduce micro-stutter.
...
* [Custom Skin Loader](https://github.com/xfl03/MCCustomSkinLoader) ⭐ 605 | 🐛 45 | 🌐 Java | 📅 2026-08-12 - Custom Skin Loader for Minecraft.
...
* [Applied Energistics 2](https://github.com/AppliedEnergistics/Applied-Energistics-2) ⭐ 1,796 | 🐛 469 | 🌐 Java | 📅 2026-09-13 - A Minecraft Mod about Matter, Energy and using them to conquer the world. Mainly focused on item storage.
* [Botania](https://github.com/Vazkii/Botania) ⭐ 1,471 | 🐛 89 | 🌐 Java | 📅 2026-09-12 - Botania is a tech mod in essence. The theme is natural magic.
* [Railcraft](https://github.com/Railcraft/Railcraft) ⭐ 526 | 🐛 170 | 🌐 Java | 📅 2023-09-20 - Greatly expand and improve the Minecart system in Minecraft.
...
* [Applied Energistics 2](https://github.com/AppliedEnergistics/Applied-Energistics-2) ⭐ 1,796 | 🐛 469 | 🌐 Java | 📅 2026-09-13 - A Minecraft Mod about Matter, Energy and using them to conquer the world.
...
* [TNTUtils](https://github.com/ljfa-ag/TNTUtils) ⭐ 9 | 🐛 2 | 🌐 Java | 📅 2026-08-02 - More control over explosions in Minecraft.
...
* [WorldEdit](https://github.com/EngineHub/WorldEdit) ⭐ 3,503 | 🐛 177 | 🌐 Java | 📅 2026-09-13 - WorldEdit is an open source in-game map editor available for Bukkit, Forge, MinecraftEdu, and many other platforms.
...
* [ViaVersion](https://github.com/MylesIsCool/ViaVersion) ⭐ 1,625 | 🐛 76 | 🌐 Java | 📅 2026-09-04 - Allows the connection of newer clients to older server versions for Minecraft servers.
* [CoreProtect](https://github.com/PlayPro/CoreProtect) ⭐ 986 | 🐛 114 | 🌐 Java | 📅 2026-09-13 - Log everything your players do. Literally 1984.
* [WorldGuard](https://github.com/EngineHub/WorldGuard) ⭐ 938 | 🐛 160 | 🌐 Java | 📅 2026-08-11 - WorldGuard lets you and players guard areas of land against griefers and undesirables, as well as tweak and disable various gameplay features of Minecraft.
...
* [Blessing Skin Server](https://github.com/bs-community/blessing-skin-server) ⭐ 1,048 | 🐛 26 | 🌐 PHP | 📅 2026-03-30 - A web application brings your custom skins back in offline Minecraft servers.
...
* [Docker-Minecraft](https://github.com/itzg/docker-minecraft-server) ⭐ 14,301 | 🐛 139 | 🌐 Shell | 📅 2026-09-13 - A self-hosted Minecraft server using Docker containers.
* [Gate](https://github.com/minekube/gate) ⭐ 1,076 | 🐛 48 | 🌐 Go | 📅 2026-09-14 - A high performance & paralleled Minecraft proxy written in Go.
* [Legendary-Java-Minecraft-Geyser-Floodgate](https://github.com/TheRemote/Legendary-Java-Minecraft-Geyser-Floodgate) ⭐ 224 | 🐛 1 | 🌐 Shell | 📅 2026-05-03 - PaperMC server with out of the box Geyser and Floodgate support using docker.
* [minecraft-docker](https://github.com/tywil04/minecraft-docker) ⚠️ Archived - Fork of [Legendary-Java-Minecraft-Geyser-Floodgate](https://github.com/TheRemote/Legendary-Java-Minecraft-Geyser-Floodgate) ⭐ 224 | 🐛 1 | 🌐 Shell | 📅 2026-05-03 that embeds a discord bot for easy starting and stopping of the server.
...
* [node-minecraft-protocol](https://github.com/PrismarineJS/node-minecraft-protocol) ⭐ 1,414 | 🐛 133 | 🌐 JavaScript | 📅 2026-09-14 - A NodeJS library to parse and serialize minecraft packets, plus authentication and encryption.
* [MCProtocolLib](https://github.com/Steveice10/MCProtocolLib) ⭐ 910 | 🐛 17 | 🌐 Java | 📅 2026-09-13 - A simple library for communicating with a Minecraft client/server, written in Java.
...
* [Amidst](https://github.com/toolbox4minecraft/amidst) ⭐ 2,267 | 🐛 268 | 🌐 Java | 📅 2025-12-01 - Display an overview of a Minecraft world, without actually creating it.
* [Amulet](https://github.com/Amulet-Team/Amulet-Map-Editor) ⭐ 2,237 | 🐛 198 | 🌐 Python | 📅 2026-09-04 - Map viewer/editor.
...
* [HMCL](https://github.com/huanghongxun/HMCL) ⭐ 10,069 | 🐛 473 | 🌐 Java | 📅 2026-09-14 - A powered Minecraft launcher that supports a lot of features.
* [MultiMC](https://github.com/MultiMC/MultiMC5) ⭐ 4,675 | 🐛 324 | 🌐 C++ | 📅 2026-07-28 - A custom launcher for Minecraft that allows you to easily manage multiple installations of Minecraft at once.
* [XMCL](https://github.com/Voxelum/x-minecraft-launcher) ⭐ 1,593 | 🐛 57 | 🌐 TypeScript | 📅 2026-09-12 - X Minecraft Launcher (XMCL) is a modern Minecraft launcher that lets you manage your massive resources like modpacks, resource packs, mods and shader packs.
* [Polymerium](https://github.com/d3ara1n/Polymerium) ⭐ 118 | 🐛 9 | 🌐 C# | 📅 2026-09-11 - 🐿️ A next-generation Minecraft instance manager that thinks differently about game management.
...
* [BON 2](https://github.com/tterrag1098/BON2) ⭐ 190 | 🐛 11 | 🌐 Java | 📅 2022-09-11 - A rewrite of the Bearded Octo Nemesis project with support for ForgeGradle.
* [SchematicWebViewer](https://github.com/EngineHub/SchematicWebViewer) ⭐ 77 | 🐛 4 | 🌐 TypeScript | 📅 2025-12-22 - A JavaScript/TypeScript library for rendering and viewing Minecraft schematic files on the web.
